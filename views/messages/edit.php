...
<div class="col-4 mx-auto pt-3">
  <form action="/<?php echo Config::getAppPath(); ?>/messages/update/<?php echo $message['id']; ?>" method="POST" class="mb-3">
    ...
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" class="form-control" value="<?php echo $message['title']; ?>" required>
    </div>
    <div class="form-group">
        <label for="message">Message:</label>
        <textarea name="message" id="message" class="form-control" required><?php echo $message['message']; ?></textarea>
    </div>
